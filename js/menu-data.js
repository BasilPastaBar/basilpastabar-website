/*
  ...
  Tags you can use on an item:
    ...
    featured: true           -> included in the "Fan Favorites" strip near the top
    image: "images/dishes/x.jpg" -> photo shown as a big card in the menu
                                    (leave it out and the item shows as a plain
                                    text row instead — used for small add-ons)
    sizes: [{label, price}]  -> use instead of "price" for small/large items
  ============================================================
*/
...
const MENU_DATA = {
  ...
  categories: [
    {
      ...
      name: "House Specials",
      items: [
        { name: "Spaghetti Puttanesca", spicy: true, price: 15.95, featured: true, image: "images/dishes/puttanesca.jpg",
        ...
        { name: "Penne Arrabiata", spicy: true, price: 15.95, featured: true, image: "images/dishes/penne-arrabiata.jpg",
          desc: "Spicy marinara sauce with chorizo sausage, red peppers and garlic. Garnished with goat cheese & fresh parsley." },
        { name: "Pesto Shrimp Linguine", price: 15.95, featured: true, image: "images/dishes/pesto-shrimp-linguine.jpg",
          desc: "Pesto cream sauce with white wine, shrimp, garlic and spinach. Garnished with parmesan cheese & fresh basil." },
        { name: "Chicken Curry Fettuccine", price: 13.95, featured: true, image: "images/dishes/chicken-curry-fettuccine.jpg",
          desc: "Curry cream sauce with chicken, red peppers, peas and spinach. Garnished with fresh oregano." },
        { name: "Spaghetti Carbonara", price: 13.95, image: "images/dishes/spaghetti-carbonara.jpg",
          desc: "Parmesan cream sauce with egg yolk, crispy smoked bacon and peas. Garnished with fresh parsley." },
        { name: "BC Smoked Salmon Fettuccine", price: 15.95, featured: true, image: "images/dishes/bc-smoked-salmon-fettuccine.jpg",
          desc: "Alfredo cream sauce with wild smoked salmon, red onions, tomatoes, spinach & capers." },
        { name: "Lemon Chicken Fettuccine", price: 15.95, image: "images/dishes/lemon-chicken-fettuccine.jpg",
          desc: "Alfredo cream sauce with lemon juice, chicken, zucchini & capers. Garnished with parmesan cheese & fresh basil." },
        { name: "Maple Bacon Conchiglie", price: 15.95, image: "images/dishes/maple-bacon-conchiglie.jpg",
        ...
        { name: "Gnocchi Bolognese", price: 16.45, image: "images/dishes/gnocchi-bolognese.jpg",
          desc: "Marinara beef sauce with mushrooms. Garnished with parmesan cheese, fresh parsley & fresh basil." },
        { name: "Spaghetti & Meatballs", spicy: true, price: 15.95, image: "images/dishes/spaghetti-meatballs.jpg",
    ...
    },
    {
      ...
      name: "Vegetarian",
      items: [
        { name: "Fussily Primavera", veg: true, price: 15.95, image: "images/dishes/fussily-primavera.jpg",
        ...
        { name: "Fresh Herbs Linguine Aioli", veg: true, price: 15.95, image: "images/dishes/linguine-aioli.jpg",
        ...
        { name: "Mediterranean Penne", veg: true, price: 15.95, image: "images/dishes/mediterranean-penne.jpg",
          desc: "Basil pesto sauce with artichoke hearts, asparagus, tomatoes & spinach. Garnished with goat cheese & fresh parsley." },
        { name: "Four Cheese Ravioli", veg: true, price: 16.45, image: "images/dishes/four-cheese-ravioli.jpg",
          desc: "Tomato cream sauce (rose) with spinach. Garnished with parmesan cheese & fresh basil." },
        { name: "Coconut Cream Ravioli", price: 16.45, image: "images/dishes/coconut-cream-ravioli.jpg",
    ...
    },
    {
      ...
      name: "Sides & Salads",
      items: [
        { name: "Garlic Bread", price: 2.75, image: "images/dishes/garlic-bread.jpg",
          desc: "Oven baked to perfection. Add cheese +$1.95." },
        { name: "Soup of the Day", sizes: [{ label: "Small", price: 4.45 }, { label: "Large", price: 7.45 }],
          image: "images/dishes/soup-of-the-day.jpg",
          desc: "Vegetable minestrone or green lentils." },
        ...
        { name: "Classic Caesar", sizes: [{ label: "Small", price: 5.45 }, { label: "Large", price: 9.95 }],
          image: "images/dishes/classic-caesar.jpg",
          desc: "Romaine lettuce, croutons, capers & parmesan cheese." },
        { name: "House Special Greens", sizes: [{ label: "Small", price: 5.45 }, { label: "Large", price: 9.95 }],
          image: "images/dishes/house-special-greens.jpg",
    ...
    },
    {
      ...
      name: "Desserts",
      items: [
        { name: "Tiramisu Cake", price: 6.95, image: "images/dishes/tiramisu.jpg",
        ...
        { name: "Lemon Cream Cake", price: 6.95, image: "images/dishes/lemon-cream-cake.jpg",
  ...
  buildYourOwn: {
    image: "images/dishes/build-your-own.jpg",
    startingPrice: 13.95,
